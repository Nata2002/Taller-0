...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Taller 0 consultar el pais del atleta ");
	...
	private void ejecutarPaisPorAtleta()
	{
		...
		String atleta= input ("Por favor ingrese el nimbre del atleta");
		String pais = calculadora.PaisPorAtletla(atleta);
		System.out.println("\n"+"El Pais que replesenta el  atleta "+  atleta + " es " + pais + "\n");
	}
